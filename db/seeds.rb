...
tipomedallas = Tipomedalla.create([{ nombre: 'Viaje' }, { nombre: 'Social' }, { nombre: 'Retro' }])
...
viajes = Viaje.create([{ruta_id:1,horainicio:10,estadoviaje_id:1,estatus:1},
	{ruta_id:1,horainicio:13,fecha:"29/09/2014", estadoviaje_id:1,estatus:1},
	{ruta_id:2,horainicio:9,fecha:"29/09/2014", estadoviaje_id:1,estatus:1},
	{ruta_id:2,horainicio:15,fecha:"29/09/2014", estadoviaje_id:1,estatus:1}])
...
vans = Van.create([{placa:"XD-345",modelo:"Ducato",capacidad:15,co2gxkm:245, pais_id:1,fecha_compra:"19/02/2004"},
	{placa:"XD-344",modelo:"Ducato",capacidad:15,co2gxkm:245, pais_id:1,fecha_compra:"19/02/2004"},
	{placa:"XD-343",modelo:"Ducato",capacidad:15,co2gxkm:245, pais_id:1,fecha_compra:"19/02/2004"}])
