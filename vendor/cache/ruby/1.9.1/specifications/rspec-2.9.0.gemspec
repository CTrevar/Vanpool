...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-2.9.0"

  if s.respond_to? :specification_version then
    s.specification_version = 3

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-core>, ["~> 2.9.0"])
      s.add_runtime_dependency(%q<rspec-expectations>, ["~> 2.9.0"])
      s.add_runtime_dependency(%q<rspec-mocks>, ["~> 2.9.0"])
    else
